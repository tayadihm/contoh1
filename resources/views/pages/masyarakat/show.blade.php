                ...
                <div class="w-full overflow-x-auto">
                    @foreach ($item->details as $ite)
                        <div
                            ...
                            <h6>Nama : {{ $ite->name }}</h6>
                            <h6 class="mt-4">NIK : {{ $ite->user_nik }}</h6>
                            <h6 class="mt-4">No Telepon : {{ $item->user->phone }}</h6>
                            <h6 class="mt-4">Tanggal : {{ $ite->created_at->format('l, d F Y - H:i:s') }}</h6>
                        ...
                        <div class="px-4 py-3 mb-8 flex text-gray-800 bg-white rounded-lg shadow-md dark:bg-gray-800">
                            <div class="relative hidden mr-3  md:block ">
                                <h4 class="text-center mb-8 font-semibold">Foto</h4>
